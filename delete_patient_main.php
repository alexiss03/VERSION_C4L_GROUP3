        ...
        <div class="article">
          ...
          <div class="row-fluid">
			    ...
			    if ($rows > 0){
			      ...
			      ";
			          ...
			          <tr>
			              <td>$row->username</td>
			              <td>$row->name</td>
			              <td><a href='delete_patient.php?username=$row->username&submit='Submit' onclick='return delete_me();'>Delete</a></td>
			          </tr>";
			          }
			...
			<tr>
			    ...
			    <td><a href="delete_patient.php?username=<?php echo $row->username;?>&submit=Submit" onclick='return delete_me();'>Delete</a></td>
			</tr>
			<?php
			    }
