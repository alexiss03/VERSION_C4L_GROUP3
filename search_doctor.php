    ...
    <div class="content">
      <div class="container">
        <div class="article">
          ...
          <div class="row-fluid">
            <form name="homepage" action="search_doctor_results.php" method="post" enctype="multipart/form-data" id="homepage">
            <input type="text" name="searchDoctorHere" id="searchDoctorHere" size=50 />
            <input type="submit"  value="Search" name="searchdoctor" style="height: 30px; width: 165px"/>
          </div>
        </div>
      </div>
    </div>
